...
enum NativeInspectorSymbolResolverCore {
    ...
    static func currentSymbolQueries() -> NativeInspectorSymbols {
        ...
        // WTF::String const&
        let stringReference = decodedString([0xF0, 0xF3, 0xE1, 0x9D, 0x9D, 0xF4, 0xD3, 0xD5, 0xCE, 0xC9, 0xC0, 0x87, 0xC4, 0xC8, 0xC9, 0xD4, 0xD3, 0x81])
            ...
            connectFrontend: NativeInspectorRequiredSymbol(
                ...
                queries: [
                    query(
                        ...
                        functionName: [0xF0, 0xC2, 0xC5, 0xEC, 0xCE, 0xD3, 0x9D, 0x9D, 0xF0, 0xC2, 0xC5, 0xF7, 0xC6, 0xC0, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
            ...
            disconnectFrontend: NativeInspectorRequiredSymbol(
                ...
                queries: [
                    query(
                        ...
                        functionName: [0xF0, 0xC2, 0xC5, 0xEC, 0xCE, 0xD3, 0x9D, 0x9D, 0xF0, 0xC2, 0xC5, 0xF7, 0xC6, 0xC0, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC3, 0xCE, 0xD4, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
            ...
            inspectorControllerConnectTargets: NativeInspectorRequiredSymbol(
                ...
                queries: [
                    query(
                        ...
                        functionName: [0xF0, 0xC2, 0xC5, 0xE4, 0xC8, 0xD5, 0xC2, 0x9D, 0x9D, 0xF7, 0xC6, 0xC0, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
                        parameterTypes: [frontendChannel, "bool", "bool"]
                    ),
                    query(
                        // WebCore::FrameInspectorController::connectFrontend
                        functionName: [0xF0, 0xC2, 0xC5, 0xE4, 0xC8, 0xD5, 0xC2, 0x9D, 0x9D, 0xE1, 0xD5, 0xC6, 0xCA, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
                        parameterTypes: [frontendChannel, "bool", "bool"]
                    ),
                ],
            ...
            inspectorControllerDisconnectTargets: NativeInspectorRequiredSymbol(
                ...
                queries: [
                    query(
                        ...
                        functionName: [0xF0, 0xC2, 0xC5, 0xE4, 0xC8, 0xD5, 0xC2, 0x9D, 0x9D, 0xF7, 0xC6, 0xC0, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC3, 0xCE, 0xD4, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
                        parameterTypes: [frontendChannel]
                    ),
                    query(
                        // WebCore::FrameInspectorController::disconnectFrontend
                        functionName: [0xF0, 0xC2, 0xC5, 0xE4, 0xC8, 0xD5, 0xC2, 0x9D, 0x9D, 0xE1, 0xD5, 0xC6, 0xCA, 0xC2, 0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0xE4, 0xC8, 0xC9, 0xD3, 0xD5, 0xC8, 0xCB, 0xCB, 0xC2, 0xD5, 0x9D, 0x9D, 0xC3, 0xCE, 0xD4, 0xC4, 0xC8, 0xC9, 0xC9, 0xC2, 0xC4, 0xD3, 0xE1, 0xD5, 0xC8, 0xC9, 0xD3, 0xC2, 0xC9, 0xC3],
                        parameterTypes: [frontendChannel]
                    ),
                ],
                resolutionPolicy: .fallbackCallTarget
            ...
            backendDispatcherDispatch: NativeInspectorRequiredSymbol(
                ...
                queries: [
                    query(
                        ...
                        functionName: [0xEE, 0xC9, 0xD4, 0xD7, 0xC2, 0xC4, 0xD3, 0xC8, 0xD5, 0x9D, 0x9D, 0xE5, 0xC6, 0xC4, 0xCC, 0xC2, 0xC9, 0xC3, 0xE3, 0xCE, 0xD4, 0xD7, 0xC6, 0xD3, 0xC4, 0xCF, 0xC2, 0xD5, 0x9D, 0x9D, 0xC3, 0xCE, 0xD4, 0xD7, 0xC6, 0xD3, 0xC4, 0xCF],
