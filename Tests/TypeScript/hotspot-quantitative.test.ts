...
import {
    ...
    setThrottleOptions,
    trackedRequests
} from "../../Sources/WebInspectorScripts/TypeScript/Runtime/NetworkAgent/network-agent-utils";
import { installFetchPatch } from "../../Sources/WebInspectorScripts/TypeScript/Runtime/NetworkAgent/network-agent-http";
