...
import * as domAgentSnapshot from "../../Sources/WebInspectorScripts/TypeScript/Runtime/DOMAgent/dom-agent-snapshot";
import {
    collectStyleSheetsWithScope,
    matchedStylesForNode
} from "../../Sources/WebInspectorScripts/TypeScript/Runtime/DOMAgent/dom-agent-styles";
