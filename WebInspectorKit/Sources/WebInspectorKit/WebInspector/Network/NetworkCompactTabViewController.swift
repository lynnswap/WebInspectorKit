...
@MainActor
final class NetworkCompactTabViewController: UIViewController, UINavigationControllerDelegate {
    private let inspector: WINetworkTabViewModel
    private let listPaneViewController: NetworkListPaneViewController
    ...
    init(inspector: WINetworkTabViewModel) {
        ...
        self.listPaneViewController = NetworkListPaneViewController(inspector: inspector)
    ...
    private func showDetailIfNeeded(for entry: NetworkEntry, animated: Bool) {
        ...
        let detailViewController = NetworkDetailViewController(
            inspector: inspector,
