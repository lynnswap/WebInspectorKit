...
@MainActor
package final class V2_DOMElementViewController: UIViewController {
    ...
    private func render() {
        ...
        if dom.currentPageRootNode == nil {
            applyUnavailableState(
                text: v2WILocalized("dom.element.loading", default: "Loading DOM..."),
                secondaryText: nil,
        ...
        guard let selectedNode = dom.selectedNode else {
            applyUnavailableState(
                text: v2WILocalized("dom.element.select_prompt", default: "Select an element"),
                secondaryText: v2WILocalized("dom.element.hint", default: "Choose a node in the DOM tree to inspect it."),
        ...
        applyUnavailableState(
            text: v2WILocalized("dom.element.placeholder.title", default: "Element details"),
...
#Preview("V2 DOM Element") {
    ...
    return UINavigationController(rootViewController: V2_DOMElementViewController(dom: dom))
}
#endif
#endif
