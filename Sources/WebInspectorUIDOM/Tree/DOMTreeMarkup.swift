...
extension DOMTreeTextView {
    enum MarkupBuilder {
        ...
        static func rendersClosingTagRow(for node: DOMTreeTextView.RowRenderNode) -> Bool {
        ...
        static func canContainChildNodes(_ node: DOMTreeTextView.RowRenderNode) -> Bool {
            switch inferredNodeType(for: node) {
        ...
        private static func inferredNodeType(for node: DOMTreeTextView.RowRenderNode) -> DOMNode.Kind {
        ...
        private static func elementMarkup(for node: DOMTreeTextView.RowRenderNode, hasDisclosure: Bool, isOpen: Bool) -> DOMTreeTextView.Markup {
        ...
        private static func closingElementMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
            let name = elementName(for: node)
            var markup = DOMTreeTextView.Markup()
            markup.append("</", kind: .punctuation)
            markup.append(name, kind: .tagName)
        ...
        private static func documentFragmentMarkup(for node: DOMTreeTextView.RowRenderNode, isTemplateContent: Bool) -> DOMTreeTextView.Markup {
        ...
        private static func textMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
        ...
        private static func commentMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
            var markup = DOMTreeTextView.Markup()
            markup.append("<!--", kind: .punctuation)
        ...
        private static func documentTypeMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
            var markup = DOMTreeTextView.Markup()
        ...
        private static func cdataMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
            var markup = DOMTreeTextView.Markup()
        ...
        private static func processingInstructionMarkup(for node: DOMTreeTextView.RowRenderNode) -> DOMTreeTextView.Markup {
            var markup = DOMTreeTextView.Markup()
            markup.append("<?", kind: .punctuation)
        ...
        private static func elementName(for node: DOMTreeTextView.RowRenderNode, fallback: String = "element") -> String {
            let rawName: String
        ...
        private static func fallbackPreview(for node: DOMTreeTextView.RowRenderNode) -> String {
        ...
        private static func normalizedValue(for node: DOMTreeTextView.RowRenderNode) -> String {
