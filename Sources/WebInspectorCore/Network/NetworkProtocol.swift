...
extension NetworkRequest {
    package struct ID: Hashable, Sendable {        package var targetID: ProtocolTarget.ID
...
extension NetworkRequest.RedirectHop {
    package struct ID: Hashable, Sendable {        package var requestKey: NetworkRequest.ID
...
extension NetworkRequest {
    package struct BackendResourceID: Hashable, Codable, Sendable {        package var sourceProcessID: String
...
extension NetworkCommand {
    package enum Intent: Equatable, Sendable {        case getResponseBody(
...
extension NetworkRequest {
    package struct ReferrerPolicy: RawRepresentable, Hashable, Sendable {        package let rawValue: String
...
extension NetworkRequest {
    package struct Payload: Equatable, Sendable {        package var url: String
...
extension NetworkRequest.Timing {
    package struct Payload: Equatable, Sendable {        package var startTime: Double
...
extension NetworkRequest.Security {
    package struct ConnectionPayload: Equatable, Sendable {        package var protocolName: String?
...
extension NetworkRequest.Security {
    package struct CertificatePayload: Equatable, Sendable {        package var subject: String?
...
extension NetworkRequest.Security {
    package struct Payload: Equatable, Sendable {        package var connection: NetworkRequest.Security.ConnectionPayload?
...
extension NetworkRequest.Response {
    package struct Source: RawRepresentable, Hashable, Sendable {        package let rawValue: String
...
extension NetworkRequest {
    package struct ResourceType: RawRepresentable, Hashable, Sendable {        package let rawValue: String
...
extension NetworkRequest {
    package struct Priority: RawRepresentable, Hashable, Sendable {        package let rawValue: String
...
extension NetworkRequest.Metrics {
    package struct Payload: Equatable, Sendable {        package var networkProtocol: String?
...
extension NetworkRequest.Initiator {
    package struct Kind: RawRepresentable, Hashable, Sendable {        package let rawValue: String
...
extension NetworkRequest.WebSocket {
    package struct RequestPayload: Equatable, Sendable {        package var headers: [String: String]
...
extension NetworkRequest.WebSocket {
    package struct ResponsePayload: Equatable, Sendable {        package var status: Int
        package var statusText: String
        package var headers: [String: String]
...
extension NetworkRequest.WebSocket {
    package struct FramePayload: Equatable, Sendable {        package var opcode: Int
...
extension NetworkRequest {
    package enum State: Equatable, Sendable {        case pending
        case responded
        case finished
