...
extension ConsoleMessage {
    package struct CallFramePayload: Equatable, Sendable, Codable {
...
extension ConsoleMessage {
    package struct StackTracePayload: Equatable, Sendable, Codable {
        package var callFrames: [ConsoleMessage.CallFramePayload]
