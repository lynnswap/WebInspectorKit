...
extension ConsoleMessage {
    package struct Source: RawRepresentable, Hashable, Codable, Sendable {
...
extension ConsoleMessage {
    package struct Level: RawRepresentable, Hashable, Codable, Sendable {
        package let rawValue: String
...
extension ConsoleSession {
    package struct ClearReason: RawRepresentable, Hashable, Codable, Sendable {
        package let rawValue: String
