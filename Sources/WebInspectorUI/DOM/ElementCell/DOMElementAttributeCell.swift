...
final class DOMElementAttributeCell: DOMElementBaseCell {
    private let stackView = UIStackView()
    private let nameTextView = DOMElementSelectableTextView(frame: .zero, textContainer: nil)
    private let valueTextView = DOMElementSelectableTextView(frame: .zero, textContainer: nil)
