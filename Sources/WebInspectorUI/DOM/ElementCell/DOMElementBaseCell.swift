...
class DOMElementBaseCell: UICollectionViewListCell {
    private static let minimumHeight: CGFloat = 44

    private let observationScope = ObservationScope()

    var selectableTextViewsForSizing: [DOMElementSelectableTextView] {
        []
    }
...
final class DOMElementSelectableTextView: UITextView {
