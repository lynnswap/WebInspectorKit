...
flowchart TD
    ...
    CompactTree["V2_DOMTreeViewController<br/>UINavigationController"]
    CompactElement["V2_DOMElementViewController<br/>UIViewController"]
    RegularTree["V2_DOMTreeViewController<br/>UINavigationController"]
    ...
    CompactTreeContent["V2_DOMTreeContentViewController<br/>UIViewController<br/>private"]
    RegularTreeContent["V2_DOMTreeContentViewController<br/>UIViewController<br/>private"]
    ...
    DOMSplit --> RegularTree
    DOMSplit --> RegularElementNavigation
    RegularElementNavigation --> RegularElement

    CompactTree --> CompactTreeContent
    RegularTree --> RegularTreeContent
...
- `V2_DOMTreeViewController` は `UINavigationController` で、root に private な `V2_DOMTreeContentViewController` を持つ。
