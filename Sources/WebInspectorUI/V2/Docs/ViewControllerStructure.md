...
flowchart TD
    ...
    NetworkCompact["V2_NetworkCompactViewController<br/>V2_NetworkListViewController<br/>UICollectionViewController"]
...
- compact Network は `V2_WICompactTabNavigationController` の root に `V2_NetworkCompactViewController` を持つ。`V2_NetworkCompactViewController` は `V2_NetworkListViewController` ベース。
