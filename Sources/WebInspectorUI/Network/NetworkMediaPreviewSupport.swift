...
extension NetworkRequest.Display {
    package enum MediaPreviewKind: Equatable, Sendable {        case image
        case movie
        case hlsPlaylist
    }
}
...
extension NetworkRequest.Display {
    package enum MediaPreviewClassification: Equatable, Sendable {        case previewable(NetworkRequest.Display.MediaPreviewKind)
        case notPreviewable
        case unknown
    }
}
...
extension NetworkRequest.Display {
    package enum MediaPreviewSupport {        package static func previewKind(mimeType: String?, url: String?) -> NetworkRequest.Display.MediaPreviewKind? {
