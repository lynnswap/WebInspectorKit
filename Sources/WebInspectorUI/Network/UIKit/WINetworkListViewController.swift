...
@MainActor
public final class WINetworkListViewController: UICollectionViewController, UISearchResultsUpdating {
    ...
    public override func viewDidLoad() {
        ...
        syncSearchControllerTextFromInspector()
    ...
    public func updateSearchResults(for searchController: UISearchController) {
        ...
        guard inspector.searchText != nextSearchText else {
            return
        }
        inspector.setSearchText(nextSearchText)
    }
    ...
    func applyCompactNavigationItems(to navigationItem: UINavigationItem) {
        ...
        navigationItem.setRightBarButtonItems([filterMenuController.item], animated: false)
...
//        navigationItem.hidesSearchBarWhenScrolling = false
    ...
    private func syncSearchControllerTextFromInspector() {
        guard searchController.searchBar.text != inspector.searchText else {
            return
        }
        searchController.searchBar.text = inspector.searchText
    }
