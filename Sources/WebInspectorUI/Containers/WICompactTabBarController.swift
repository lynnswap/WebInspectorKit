...
@MainActor
final class WICompactTabBarController: UITabBarController, UITabBarControllerDelegate {
    private let session: WISession
    private let tabTransitionAnimator = WINoAnimationTabTransitionAnimator()
    private var nativeTabByItemID: [TabDisplayItem.ID: UITab] = [:]
    private let observationScope = ObservationScope()
    private var isRenderingSelection = false

    init(session: WISession) {
...
@MainActor
private final class WINoAnimationTabTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
