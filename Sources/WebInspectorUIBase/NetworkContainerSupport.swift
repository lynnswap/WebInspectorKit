...
extension UIViewController {
    ...
    package func webInspectorDetachFromContainerForReuse() {
...
@MainActor
package func webInspectorApplyNavigationControllerBackground(to navigationController: UINavigationController) {
...
@MainActor
package func webInspectorConfigureScrollEdgeObservedScrollView(
...
@MainActor
package final class RegularSplitColumnNavigationController: UINavigationController {
