import {protocolState} from "./DOMTreeState.js";
import {safeParseJSON} from "./DOMTreeUtilities.js";

let requestChildNodesHandler = null;

export function setRequestChildNodesHandler(handler) {
...
export function sendProtocolMessage(message) {
...
export function dispatchMessageFromBackend(message) {
...
export function onProtocolEvent(method, handler) {
...
export function emitProtocolEvent(method, params, rawMessage) {
...
export function reportInspectorError(context, error) {
