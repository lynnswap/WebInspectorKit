...
import {applyLayoutEntry, timeNow} from "./DOMTreeUtilities.js";
import {reportInspectorError, sendCommand} from "./DOMTreeProtocol.js";
import {
    findInsertionIndex,
    indexNode,
...
export async function requestNodeRefresh(nodeId, options = {}) {
...
export function refreshTreeAfterDomUpdates(nodesToRefresh, modifiedAttrsByNode = new Map()) {
...
export function dispatchDomUpdates(payload) {
    try {
