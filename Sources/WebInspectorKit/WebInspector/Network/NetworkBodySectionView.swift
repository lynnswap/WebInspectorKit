...
extension WebInspector {
    struct NetworkBodySectionView: View {
        ...
        var body: some View {
            NavigationLink {
                WebInspector.NetworkBodyPreviewView(entry: entry, inspector: inspector, bodyState: bodyState)
        ...
        private var formPreviewEntries: [NetworkBody.FormEntry] {
        ...
        private func decodedText(from body: NetworkBody) -> String? {
        ...
        private func formEntryValue(_ entry: NetworkBody.FormEntry) -> String {
